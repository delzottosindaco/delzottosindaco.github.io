        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div className="flex flex-col md:flex-row gap-8 items-start mb-12">
            ...
            <div>
              ...
              <p className="text-primary font-bold uppercase tracking-widest text-xs mb-6">{candidate.name === "Pierangelo Del Zotto" ? "Candidato Sindaco per Venezia" : "Candidato al Consiglio Comunale"}</p>
...
const Candidates = ({ user, isAdmin, onLogin, onLogout, devMode }: { user: User | null, isAdmin: boolean, onLogin: () => void, onLogout: () => void, devMode: boolean }) => {
  ...
  const defaultCandidates: Candidate[] = [
    { name: "Pierangelo Del Zotto", img: "/pierangelo-del-zotto.jpg", age: 72, position: 0, criminalRecordUrl: "/casellari/pierangelo-del-zotto.pdf", cvText: "Pierangelo Del Zotto è un commercialista veneziano con oltre quarant'anni di esperienza nei bilanci pubblici, nella revisione contabile e nella gestione economico-finanziaria degli enti locali. Nato a Venezia, si è diplomato in Ragioneria e si è laureato in Economia e Commercio all'Università Ca' Foscari, dove ha approfondito in particolare il tema dei servizi pubblici e dei trasporti. Dopo un'esperienza in banca nei settori fidi e finanza, ha intrapreso la libera professione aprendo il proprio studio al Lido di Venezia, affiancando all'attività di consulente quella di docente di Economia Aziendale.\n\nNel corso della sua carriera ha ricoperto numerosi incarichi come revisore dei conti e presidente di collegi sindacali in comuni, aziende sanitarie e società pubbliche e partecipate, maturando una conoscenza diretta e approfondita del funzionamento della macchina amministrativa. Dal 2009 al 2013 è stato Assessore al Bilancio della Provincia di Venezia, con delega ai servizi economico-finanziari, alla programmazione e al controllo di gestione. Oggi è segretario nazionale di Prima il Veneto e si candida a sindaco di Venezia con un programma incentrato su trasparenza dei conti, sicurezza, casa, trasporti e tutela della città e della laguna, convinto che questa sia l'ultima chiamata per restituire futuro e residenzialità a Venezia e alla sua terraferma." },
  ...
  return (
    <section id="candidati" className="pt-16 pb-6 bg-surface">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Banner Elezioni Trasparenti */}
        <div className="mb-12 border border-primary/20 rounded-xl bg-primary/5 px-6 py-5">
          <h4 className="text-primary text-sm font-black uppercase tracking-widest mb-3">Elezioni Trasparenti</h4>
          <p className="text-on-surface/80 text-sm leading-relaxed">
            In ottemperanza alla <span className="font-semibold">«Legge 9 gennaio 2019, n. 3 — Misure per il contrasto dei reati contro la pubblica amministrazione, nonché in materia di prescrizione del reato e in materia di trasparenza dei partiti e movimenti politici»</span>, vengono pubblicati i curriculum vitae e i certificati del casellario giudiziario dei candidati al Consiglio Comunale secondo l'elenco depositato.
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        />
        {/* Banner Elezioni Trasparenti - visibile subito sotto il menu */}
        <a
          href="#candidati"
          onClick={e => { e.preventDefault(); document.getElementById('candidati')?.scrollIntoView({ behavior: 'smooth' }); }}
          className="block w-full bg-primary text-on-primary py-4 px-6 text-center hover:bg-primary/90 transition-colors group cursor-pointer"
        >
          <div className="max-w-4xl mx-auto flex items-center justify-center gap-3">
            <Shield size={20} className="shrink-0" />
            <div>
              <span className="font-black uppercase tracking-widest text-base">Elezioni Trasparenti</span>
              <span className="mx-3 opacity-60">—</span>
              <span className="text-sm opacity-90">Consulta i CV e i casellari giudiziari di tutti i candidati</span>
            </div>

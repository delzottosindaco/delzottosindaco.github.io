      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          <div className="space-y-10">
            ...
            <div>
              <h5 className="text-sm font-black uppercase tracking-widest text-primary mb-4 flex items-center gap-2">
                <span className="w-8 h-[2px] bg-primary"></span> Casellario Giudiziale
              </h5>
              <p className="text-gray-900 leading-relaxed whitespace-pre-line">
                {candidate.criminalRecordText || "Nessuna annotazione presente nel casellario giudiziale."}
              </p>
            </div>
                    ...
                    <div className="flex gap-2">
                      {c.cvText ? (
                        <button
                          ...
                          className="flex-1 text-[10px] uppercase tracking-widest font-black text-primary border border-primary/20 px-3 py-1.5 rounded text-center hover:bg-primary/10 transition-all flex items-center justify-center gap-2"
                          title="Scarica CV"
                        >
                          <FileText size={12} />
                          CV ✓
      ...
      <div className="relative z-10">
        ...
        <section className="py-6 bg-surface">
          <div className="max-w-4xl mx-auto px-4 space-y-6">
            <a href="/evento-30aprile-tv.jpg" target="_blank" className="block rounded-2xl overflow-hidden shadow-xl border-2 border-[#F5E106] hover:shadow-2xl transition-shadow max-w-sm mx-auto">
              <img src="/evento-30aprile-tv.jpg" alt="Paolo Pizzolato su Rete Veneta — Giovedì 30 Aprile 2026 ore 21:15, Canale 14 digitale terrestre" className="w-full" />
            </a>
